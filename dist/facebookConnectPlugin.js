...
exports.init = function init(options) {
  function fbInit() {
    ...
    // Callbacks may themselves invoke init, so clear the pending
    // callbacks to ensure they aren't executed repeatedly
    // when re-entering init.
    callbacks = __fbCallbacks;
    __fbCallbacks = [];
